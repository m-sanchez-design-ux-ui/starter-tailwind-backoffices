    ...
    <>
      <main className="bg-white w-full min-h-[calc(100vh-37px)] p-8 flex flex-col items-center dark:bg-gray-900 font-sans relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 hidden lg:block h-10">
          <div className="w-32 h-32 2xl:w-48 2xl:h-48 absolute top-14 left-24 rounded-full bg-blue-600 opacity-10"></div>
          <div className="flex w-44 h-44 2xl:w-56 2xl:h-56 rounded-br-full bg-blue-600 opacity-15"></div>
        </div>

        <div className="w-full max-w-96 flex flex-col items-center gap-3 2xl:gap-6 h-fit my-auto z-10">
          <Image
          ...
          <section className="w-full bg-white p-6 xl:p-8 rounded-xl shadow-lg border border-gray-200">
            <div className="mb-6 text-center">
              <h1 className="text-xl font-semibold text-gray-700 dark:text-white mb-1.5">
            ...
            {success ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full mt-4 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors disabled:opacity-50"
                >
